...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " twincoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  twincoin-tx [options] <hex-tx> [commands]  Update hex-encoded twincoin transaction\n" +
            "or:     twincoin-tx [options] -create [commands]   Create hex-encoded twincoin transaction\n" +
            "\n";

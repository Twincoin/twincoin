...
Add other gitian builders keys to your gpg keyring, and/or refresh keys: See `../twincoin/contrib/gitian-keys/README.md`.
...
space *do not upload these to the twincoin.org server, nor put them in the torrent*.

...
* twincoin.conf: contains configuration settings for twincoind or twincoin-qt
* twincoind.pid: stores the process id of twincoind while running
...
* debug.log: contains debug information and general logging generated by twincoind or twincoin-qt

# Support for Output Descriptors in Twincoin Core

Since Twincoin Core v0.17, there is support for Output Descriptors in the
...
- Segwit addresses (bech32, of the form `twc1...`, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Twincoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Twincoin Core wallets, a convenience function `combo` is

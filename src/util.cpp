...
const char * const BITCOIN_CONF_FILENAME = "twincoin.conf";
const char * const BITCOIN_PID_FILENAME = "twincoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Twincoin";
#else
    // Unix
